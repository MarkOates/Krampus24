...
uint32_t PowerCoil::get_state() const
{
   return state;
}


Krampus24::Gameplay::Entities::PowerCoil::Style PowerCoil::get_style() const
{
   return style;
}


float PowerCoil::get_uv_offset_x() const
{
   return uv_offset_x;
}


float PowerCoil::get_uv_offset_y() const
{
   return uv_offset_y;
}
...
std::vector<Krampus24::Gameplay::Entities::Base*> PowerCoil::construct(AllegroFlare::ModelBin* model_bin, AllegroFlare::BitmapBin* bitmap_bin, AllegroFlare::EventEmitter* event_emitter, AllegroFlare::Physics::CollisionMesh* collision_mesh, std::string name_for_collision_faces, AllegroFlare::Vec3D initial_position, float rotation)
{
   if (!(model_bin))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"model_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"model_bin\" not met");
   }
   if (!(bitmap_bin))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"bitmap_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"bitmap_bin\" not met");
   }
   if (!(event_emitter))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"event_emitter\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"event_emitter\" not met");
   }
   if (!(collision_mesh))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"collision_mesh\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"collision_mesh\" not met");
   }
   if (!(valid_rotation(rotation)))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"valid_rotation(rotation)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::construct]: error: guard \"valid_rotation(rotation)\" not met");
   }

   // Main entity
   Krampus24::Gameplay::Entities::PowerCoil* result = new Krampus24::Gameplay::Entities::PowerCoil;
   ...
   result->body->model = model_bin->auto_get("power_coil-01-body.obj");
...
void PowerCoil::unlock()
{
   locked = false;
   return;
}

void PowerCoil::set_style(Krampus24::Gameplay::Entities::PowerCoil::Style style)
{
   this->style = style;
...
void PowerCoil::set_uv_offset_x(float uv_offset_x)
{
...
void PowerCoil::set_uv_offset_y(float uv_offset_y)
{
   this->style = STYLE_USER_CUSTOM_DEFINED_UV;
...
std::pair<float, float> PowerCoil::get_uv_offset_from_style(Krampus24::Gameplay::Entities::PowerCoil::Style style)
{
   if (!((style != STYLE_UNDEF)))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::get_uv_offset_from_style]: error: guard \"(style != STYLE_UNDEF)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::get_uv_offset_from_style]: error: guard \"(style != STYLE_UNDEF)\" not met");
   }
   switch (style)
   {
...
void PowerCoil::activate_collision_mesh()
{
   if (!(collision_mesh))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::activate_collision_mesh]: error: guard \"collision_mesh\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::activate_collision_mesh]: error: guard \"collision_mesh\" not met");
   }
...
void PowerCoil::deactivate_collision_mesh()
{
   if (!(collision_mesh))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::deactivate_collision_mesh]: error: guard \"collision_mesh\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::deactivate_collision_mesh]: error: guard \"collision_mesh\" not met");
   }
   for (auto &face_name : dynamic_collision_mesh_face_names)
   {
...
void PowerCoil::set_open_position(float open_position)
{
...
void PowerCoil::on_enter_player_bbox_collision(Krampus24::Gameplay::Entities::Base* player_entity)
{
...
void PowerCoil::on_exit_player_bbox_collision(Krampus24::Gameplay::Entities::Base* player_entity)
{
...
void PowerCoil::on_time_step(double time_step, double time_now)
{
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::on_time_step]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::on_time_step]: error: guard \"initialized\" not met");
   }
   update_state(time_step, time_now);
   return;
}

void PowerCoil::play_open_door_sound_effect()
{
...
std::map<std::string, AllegroFlare::AudioRepositoryElement> PowerCoil::build_audio_controller_sound_effect_list()
{
...
void PowerCoil::set_state(uint32_t state, bool override_if_busy)
{
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::set_state]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::set_state]: error: guard \"initialized\" not met");
   }
   if (!(is_valid_state(state)))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::set_state]: error: guard \"is_valid_state(state)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::set_state]: error: guard \"is_valid_state(state)\" not met");
   }
...
void PowerCoil::update_state(double time_step, double time_now)
{
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::update_state]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::update_state]: error: guard \"initialized\" not met");
   }
   if (!(is_valid_state(state)))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::update_state]: error: guard \"is_valid_state(state)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::update_state]: error: guard \"is_valid_state(state)\" not met");
   }
...
bool PowerCoil::is_valid_state(uint32_t state)
{
...
bool PowerCoil::is_state(uint32_t possible_state)
{
   return (state == possible_state);
}

float PowerCoil::infer_current_state_age(float time_now)
{
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[Krampus24::Gameplay::Entities::PowerCoil::infer_current_state_age]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Gameplay::Entities::PowerCoil::infer_current_state_age]: error: guard \"initialized\" not met");
   }
