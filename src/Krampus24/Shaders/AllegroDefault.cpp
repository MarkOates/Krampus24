...
AllegroDefault::AllegroDefault()
   : AllegroFlare::Shaders::Base(Krampus24::Shaders::AllegroDefault::TYPE, obtain_vertex_source(), obtain_fragment_source())
   , initialized(false)
{
}
...
void AllegroDefault::activate()
{
   if (!(initialized))
   {
      ...
      error_message << "[Krampus24::Shaders::AllegroDefault::activate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Krampus24::Shaders::AllegroDefault::activate]: error: guard \"initialized\" not met");
   }
