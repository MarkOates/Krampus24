   ...
   namespace Gameplay
   {
      namespace Entities
      {
         ...
         private:
            ...
            Krampus24::Gameplay::Entities::SlidingDoor::Style style;
            float uv_offset_x;
            float uv_offset_y;
            bool initialized;
         ...
         public:
            ...
            static std::pair<float, float> get_uv_offset_from_style(Krampus24::Gameplay::Entities::SlidingDoor::Style style=STYLE_UNDEF);
