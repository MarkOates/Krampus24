...
namespace Krampus24
{
   namespace Gameplay
   {
      namespace Entities
      {
         class PlayerShip : public Krampus24::Gameplay::Entities::Base
         {
         public:
            static constexpr char* BLENDER_IDENTIFIER = (char*)"player_ship";
         ...
         private:
            ...
            Krampus24::Gameplay::Entities::PlayerShip::Style style;
            float uv_offset_x;
            float uv_offset_y;
            bool initialized;
         ...
         public:
            ...
            Krampus24::Gameplay::Entities::PlayerShip::Style get_style() const;
            ...
            void lock();
            void unlock();
            void set_style(Krampus24::Gameplay::Entities::PlayerShip::Style style=STYLE_UNDEF);
            void set_uv_offset_x(float uv_offset_x=0.0f);
            void set_uv_offset_y(float uv_offset_y=0.0f);
            static std::pair<float, float> get_uv_offset_from_style(Krampus24::Gameplay::Entities::PlayerShip::Style style=STYLE_UNDEF);
