...
namespace Krampus24
{
   namespace Gameplay
   {
      namespace Entities
      {
         class PowerCoil : public Krampus24::Gameplay::Entities::Base
         {
         public:
            static constexpr char* BLENDER_IDENTIFIER = (char*)"power_coil";
         ...
         public:
            ...
            void lock();
            void unlock();
            void set_style(Krampus24::Gameplay::Entities::PowerCoil::Style style=STYLE_UNDEF);
            void set_uv_offset_x(float uv_offset_x=0.0f);
            void set_uv_offset_y(float uv_offset_y=0.0f);
            static std::pair<float, float> get_uv_offset_from_style(Krampus24::Gameplay::Entities::PowerCoil::Style style=STYLE_UNDEF);
