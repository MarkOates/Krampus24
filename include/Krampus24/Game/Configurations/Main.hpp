...
namespace Krampus24
{
   namespace Game
   {
      namespace Configurations
      {
         ...
         {
         public:
            static constexpr char* TYPE = (char*)"Krampus24/Game/Configurations/Main";

         private:
            Krampus24::Gameplay::Screen* primary_gameplay_screen;
         ...
         public:
            ...
            virtual std::vector<AllegroFlare::Elements::StoryboardPages::Base *> create_arbitrary_storyboard_pages_by_identifier(std::string identifier="[unset-identifier-IS_DISCARDED]") override;
