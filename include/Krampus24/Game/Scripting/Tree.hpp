   ...
   namespace Game
   {
      namespace Scripting
      {
         ...
         public:
            ...
            virtual void draw_inspect_hint(std::string inspect_hint_text="[unset-inspect_hint_text]") override;
            ...
            void set_prop_type(std::string prop_object_name="[unset-prop_object_name]", Krampus24::Gameplay::Entities::Prop::PropType prop_type=Krampus24::Gameplay::Entities::Prop::PropType::PROP_TYPE_UNDEF);
