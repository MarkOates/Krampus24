...
class Krampus24_Gameplay_Entities_PowerCoilWithConstructFixtureTest : public Krampus24::Testing::WithConstructFixture
{
};


TEST_F(Krampus24_Gameplay_Entities_PowerCoilWithConstructFixtureTest, can_be_created_without_blowing_up)
{
   std::string name ="mydoor";
   std::vector<Krampus24::Gameplay::Entities::Base*> entities = Krampus24::Gameplay::Entities::PowerCoil::construct(
   //Krampus24::Gameplay::Entities::PowerCoil *door =
   ...
   audio_controller->set_and_load_sound_effect_elements(
      Krampus24::Gameplay::Entities::PowerCoil::build_audio_controller_sound_effect_list()
   );
