...
class Krampus24_Gameplay_Entities_PigWithConstructFixtureTest : public Krampus24::Testing::WithConstructFixture
{
};


TEST_F(Krampus24_Gameplay_Entities_PigWithConstructFixtureTest, can_be_created_without_blowing_up)
{
   Krampus24::Gameplay::Entities::Pig *entity = Krampus24::Gameplay::Entities::Pig::construct(
