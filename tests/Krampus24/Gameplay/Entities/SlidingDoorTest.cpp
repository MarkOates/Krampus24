...
class Krampus24_Gameplay_Entities_SlidingDoorWithConstructFixtureTest : public Krampus24::Testing::WithConstructFixture
{
};
...
TEST_F(Krampus24_Gameplay_Entities_SlidingDoorWithConstructFixtureTest, can_be_created_without_blowing_up)
{
   ...
   audio_controller->set_and_load_sound_effect_elements(
      Krampus24::Gameplay::Entities::SlidingDoor::build_audio_controller_sound_effect_list()
   );
