...
class Krampus24_Gameplay_Entities_HorseWithConstructFixtureTest : public Krampus24::Testing::WithConstructFixture
{
};


TEST_F(Krampus24_Gameplay_Entities_HorseWithConstructFixtureTest, can_be_created_without_blowing_up)
{
   Krampus24::Gameplay::Entities::Horse *entity = Krampus24::Gameplay::Entities::Horse::construct(
