...
class Krampus24_Gameplay_Entities_ElevatorShaftWithConstructFixtureTest : public Krampus24::Testing::WithConstructFixture
{
};


TEST_F(Krampus24_Gameplay_Entities_ElevatorShaftWithConstructFixtureTest, can_be_created_without_blowing_up)
{
   std::string name ="mydoor";
   std::vector<Krampus24::Gameplay::Entities::Base*> entities = Krampus24::Gameplay::Entities::ElevatorShaft::construct(
   ...
   audio_controller->set_and_load_sound_effect_elements(
      Krampus24::Gameplay::Entities::ElevatorShaft::build_audio_controller_sound_effect_list()
   );
