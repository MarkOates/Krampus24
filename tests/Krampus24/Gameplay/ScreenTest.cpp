...
/*
class TestGameConfiguration : public Krampus24::Game:Configurations::Main
{
public:
...
TEST_F(Krampus24_Gameplay_ScreenTest, TYPE__has_the_expected_value)
{
   Krampus24::Gameplay::Screen screen;
   EXPECT_EQ("Krampus24/Gameplay/Screen", screen.get_type());
}


TEST_F(Krampus24_Gameplay_ScreenTest, type__has_the_expected_value_matching_TYPE)
{
   Krampus24::Gameplay::Screen screen;
   EXPECT_EQ(Krampus24::Gameplay::Screen::TYPE, screen.get_type());
}
